...
export default function ViewAgent({ agent }) {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <button className="mt-4 w-full py-2 text-sm font-medium bg-primary text-white rounded-md hover:bg-accent transition">
                                            View Details
                                        </button>
                                    </div>
                                </motion.div>
    ...
    return (
        <AuthenticatedLayout>
            <div className=" mx-auto rounded-xl overflow-hidden  bg-white">
                <div className="mb-4">
                    <Link href='/seller/inquiries'>Back</Link>
                </div>
            ...
            {/* Body */}
            <div className="flex flex-col mx-auto md:flex-row gap-6 mt-8 px-4 sm:px-6 lg:px-8">
