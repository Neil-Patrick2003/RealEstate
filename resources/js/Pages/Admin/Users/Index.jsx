...
import { Pencil, UserCog, Trash } from "lucide-react";
    ...
    return (
        <AdminLayout>
            <div className='flex-center-between'>
                ...
                <Link href='/admin/users/create' className='block bg-primary text-white px-3 py-2 rounded hover:bg-accent'>Add Users</Link>
            </div>
            ...
            <div className="overflow-x-auto overflow-y-auto max-h-[60vh] bg-white scrollbar-thumb-gray-300 scrollbar-track-transparent rounded-t-lg">
                <table className="min-w-full divide-y border-b divide-gray-200 text-gray-700">
                    ...
                    <tr>
                        ...
                        <th className="p-3 text-start">Joinded At</th>
                    ...
                    {users?.data?.length > 0 ? (
                        users.data.map((user) => {
                            ...
                            const lastOnline = new Date(user?.last_login).toLocaleDateString();
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td>
                                        <div
                                            className={`px-2 py-1 text-xs font-semibold rounded-full text-center w-fit
                                    ...
                                    <td className="p-3">{lastOnline}</td>
                                    ...
                                    <td className="p-3">
                                        <div className='flex gap-3'>
                                            ...
                                            <UserCog  className='text-secondary h-4 w-4 cursor-pointer'/>
                                            <Trash className='text-red-400 h-4 w-4 cursor-pointer' />
                                        </div>
            ...
            <div className="flex justify-between items-center flex-wrap gap-4 mt-4">
                ...
                <div className="text-sm text-gray-600">
                    Showing <strong>{users?.from}</strong> to <strong>{users?.to}</strong> of{" "}
