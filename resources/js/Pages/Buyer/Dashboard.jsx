                ...
                <section className="space-y-4">
                    ...
                    <div className="overflow-x-auto flex space-x-6 snap-x snap-mandatory scroll-smooth pb-2">
                        {properties.slice(0, 5).map((property) => (
                            <div key={property.id} className="min-w-[75%] sm:min-w-[300px] md:min-w-[350px] bg-white rounded-xl shadow-md snap-start hover:shadow-lg hover:scale-[1.02] transition relative">
                        ...
                        <div className='col-span-1 md:col-span-2'>
                            ...
                            <div className="overflow-x-auto bg-white shadow-sm rounded-b-lg">
                                <table className="min-w-full text-sm text-left text-gray-700">
                                    ...
                                    <tr>
                                        <th className="p-3 text-center"><input type="checkbox" id='inquiriesId'  className="rounded border-gray-400" /></th>
                                            ...
                                            return (
                                                <tr key={inquiry.id} className="hover:bg-gray-50 flex flex-col md:table-row w-full">
                                                    <td className="p-3 text-center hidden md:table-cell">
                                                        <input type="checkbox" id={inquiry.id} className="rounded border-gray-400" />
                                                    </td>
                                                    <td className="p-3 md:table-cell">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            />
                                                            <div>
                                                                <p className="font-semibold text-gray-800">{inquiry.property?.title ?? 'Unknown Property'}</p>
