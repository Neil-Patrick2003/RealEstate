...
const SlidingLoginSignup = () => {
  ...
  const buttonClasses =
    `w-full text-white bg-[#03c9d7] hover:bg-[#039bab] focus:ring-4 focus:outline-none 
        ...
        >
          ...
          <div
            className={`flex items-center justify-center flex-col px-20 transition-all  ease-in-out duration-[0.2s]
               delay-[0.7s] overflow-hidden col-start-1 col-end-2 row-start- row-end-2 py-0 z-10 max-md:px-6 
                opacity-0 ${
