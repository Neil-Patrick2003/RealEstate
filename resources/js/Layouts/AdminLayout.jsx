...
const navigation = [
    ...
    { name: 'Properties', href: '/admin/properties', icon: UsersIcon, current: false },
    { name: 'Users', href: '#', icon: FolderIcon, current: false },
    { name: 'Partners', href: '#', icon: CalendarIcon, current: false },
    { name: 'Analytics', href: '#', icon: DocumentDuplicateIcon, current: false },
    { name: 'Reports', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
    { id: 1, name: 'Agents', href: '#', initial: 'H', current: false },
        ...
        <>
            <div>
                <Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-50 lg:hidden">
                    <DialogBackdrop
                        transition
                        className="fixed inset-0 bg-green-950 transition-opacity duration-300 ease-linear data-closed:opacity-0"
                    />
                ...
                <div className="hidden bg-green-900 ring-1 ring-white/10 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                        ...
                        <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                            <form action="#" method="GET" className="grid flex-1 grid-cols-1">
                                <input
                                    ...
                                    placeholder="Search"
                                    aria-label="Search"
                                    className="col-start-1 row-start-1 block size-full bg-white pl-8 text-base border-none text-gray-900 outline-white placeholder:text-gray-400 sm:text-sm/6 dark:bg-gray-900 dark:text-white dark:placeholder:text-gray-500"
                                />
                                <MagnifyingGlassIcon
                                    aria-hidden="true"
