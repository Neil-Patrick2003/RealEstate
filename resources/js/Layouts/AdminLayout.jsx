...
import { Menu, House, UserRound, Folder, Calendar, ChartPie, X, Files, EllipsisVertical  } from 'lucide-react'
import { usePage } from '@inertiajs/react'

const navigation = [
  { name: 'Dashboard', href: '#', icon: House, current: true },
  { name: 'Team', href: '#', icon: UserRound, current: false },
    ...
    <>
      ...
      */}
      <div>
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto py-2 border border-t-1 flex-center-between">
                  <a
                    href="#"
                    className="flex items-center gap-x-1 px-2 py-3 text-sm/6 font-semibold text-gray-900 hover:bg-gray-50"
                  >
                    <img
                      alt=""
                    ...
                    <span className=' ' aria-hidden="true">
                        ...
                        <p className='text-xs font-thin'>{auth.user.email}</p>
                    </span>
                  </a>
                  <div className=' flex justify-center items-center pr-1    text-gray-900 hover:bg-gray-50'>
                    <EllipsisVertical className='text-gray-600' size={22} />
                  </div>
                </li>
              </ul>
            </nav>
        ...
        <main className="lg:pl-[240px] border">
